...
// 필수 구현 메쏘드들까지 override하면 import가 자동으로 됨.
...
// extends 하면 필수 구현 메쏘드들을 만들라고 메시지 뜸.
// 이번에는 ArrayAdapter 사용함. 일반적으로는 BaseAdapter 상속받아서 사용함.
public class ListViewBtnAdapter extends ArrayAdapter implements View.OnClickListener {

    // TODO: interface, implements 공부하기
